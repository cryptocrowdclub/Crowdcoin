...
official/supported Docker Images found at https://hub.docker.com/r/crowdcoinpay/crowdcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/crowdcoinpay/crowdcoind-develop/ when changing the above text**