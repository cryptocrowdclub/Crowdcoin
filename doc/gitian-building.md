...
in the Crowdcoin Core repository under 'Fetch and create inputs' to install sources which require
...
```bash
    ...
    From https://github.com/dashpay/crowdcoin
...
BTCPATH=/some/root/path/crowdcoin
SIGPATH=/some/root/path/crowdcoin-detached-sigs
...
[crowdcoin/gitian.sigs](https://github.com/dashpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
