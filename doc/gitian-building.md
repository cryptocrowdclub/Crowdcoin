...
```bash
    ...
    From https://github.com/crowdcoinpay/crowdcoin
...
[crowdcoin/gitian.sigs](https://github.com/crowdcoinpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
