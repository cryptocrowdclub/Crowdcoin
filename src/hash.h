...
// Copyright (c) 2017 The Crowdcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CROWDCOIN_HASH_H
#define CROWDCOIN_HASH_H
#include <iostream>
#include <chrono>
...
/** A hasher class for Crowdcoin's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for Crowdcoin's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
