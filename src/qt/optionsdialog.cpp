    ...
    mapper(0)
{
    ...
    ui->theme->addItem(QString("CRC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CRC-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("CRC-light-hires-retro"), QVariant("light-hires-retro"));
