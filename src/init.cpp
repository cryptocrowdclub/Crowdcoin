...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    privateSendClient.nPrivateSendAmount = std::min(std::max((const int64_t)GetArg("-privatesendamount", DEFAULT_PRIVATESEND_AMOUNT), MIN_PRIVATESEND_AMOUNT), MAX_PRIVATESEND_AMOUNT);
#endif // ENABLE_WALLET
