...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    privateSendClient.nPrivateSendAmount = std::min(std::max(GetArg("-privatesendamount", DEFAULT_PRIVATESEND_AMOUNT), (int64_t)MIN_PRIVATESEND_AMOUNT), MAX_PRIVATESEND_AMOUNT);
#endif // ENABLE_WALLET
