# Linearize
Construct a linear, no-fork, best version of the Crowdcoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install crowdcoin_hash

https://github.com/crowdcoinpay/crowdcoin_hash
...
JSON-RPC server. Running `crowdcoind` or `crowdcoin-qt -server` will be sufficient.
...
* `input`: crowdcoind blocks/ directory containing blkNNNNN.dat
